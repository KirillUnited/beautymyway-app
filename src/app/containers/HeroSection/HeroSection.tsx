    ...
    return (
        <section className={cn(styles.root)}>
            ...
            <div className="container">
                <div className={`${styles.inner} relative grid grid-cols-1 justify-center items-center lg:gap-14 max-w-5xl mx-auto`}>
                    <div className='flex flex-col items-center text-center py-5 z-10'>
